...
After reading an article on a very cool side project, I've found the perfect opportunity to build something analogous and,
...
There should be one main Go backend service to manage all the logic, and a smaller client will act as fake shippers,
