---
title: "#0: Creating a food delivery service simulator"
...
However, I've always felt that I'm missing something. I've never had the chance to work on a project that is big enough (a side from my day job ofcourse) to have a full picture of the whole system.
...
The objective is to create a system capable of simulating the entire process of a food delivery service like DoorDash
